...
const newProjectTask = (questions) => {
    const tasks = new Listr([
        ...
        },
        {
            ...
            task: (ctx) => {
                packageInstaller("express, react-dropzone, dotenv, cors, @ckeditor/ckeditor5-react, yvr-image-editor --force, mongoose, bcrypt, slugify, jsonwebtoken,  next@15.0.3, @tanstack/react-table, cookies-next, cross-env, axios, class-variance-authority, clsx, lucide-react, tailwind-merge, tailwindcss-animate, tailwindcss --save-dev, postcss --save-dev, yvr-core@latest");
                installComponents();
            }
        },
        {

...
const installComponents = () => {
    ...
    try {
        cp.execSync(`npx shadcn@latest add button badge progress separator card label input toast checkbox dropdown-menu sheet dialog select textarea table switch`, { stdio: 'inherit' });
